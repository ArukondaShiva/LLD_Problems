package org.example._03_trafficsignalsystem.controller;

import org.example._03_trafficsignalsystem.domain.Direction;
import org.example._03_trafficsignalsystem.domain.SignalTiming;
...
public class TimingController {
    ...
    public void setSignalTiming(int intersectionId, Direction direction, int greenDuration) {
        System.out.println("Setting signal timing for intersection " + intersectionId + ", direction " + direction + ": Y=" + SignalTiming.YELLOW_DURATION + "s, G=" + greenDuration + "s");
    ...
    public void enableDynamicTiming(int intersectionId, Direction direction, boolean enable) {
        System.out.println("Enabling dynamic timing for intersection " + intersectionId + ", direction " + direction + ": " + enable);
    ...
    public SignalTiming getSignalTiming(int intersectionId, Direction direction) {
        System.out.println("Getting signal timing for intersection " + intersectionId + ", direction " + direction);
    ...
    public void adjustTimingBasedOnTraffic(int intersectionId, Direction direction) {
        System.out.println("Adjusting timing based on traffic for intersection " + intersectionId + ", direction " + direction);
    ...
    public void displayTimingStatus(int intersectionId) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (timing != null) {
                System.out.println(direction + ": Y=" + timing.getYellowDuration() + "s, " + "G=" + timing.getGreenDuration() + "s, " + "Dynamic=" + timing.isDynamic());
            } else {

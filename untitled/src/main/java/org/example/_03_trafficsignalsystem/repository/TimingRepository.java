...
public class TimingRepository {
    ...
    public SignalTiming getSignalTiming(int intersectionId, Direction direction){
        ...
        if(timing!=null){
            System.out.println("Signal timing found for intersection " + intersectionId + ", direction " + direction);
        }
        else {
            System.out.println("Signal timing not found for intersection " + intersectionId + ", direction " + direction);
        }
    ...
    public void updateSignalTiming(int intersectionId, Direction direction, int greenDuration){
        ...
        if(timing!=null){
            ...
            System.out.println("Signal timing updated for intersection " + intersectionId + ", direction " + direction);
        }else{
            System.out.println("Signal timing not found for intersection " + intersectionId + ", direction " + direction);
        }
    }
    ...
    public void enableDynamicTiming(int intersectionId, Direction direction, boolean enable) {
        ...
        if (timing != null) {
            ...
            System.out.println("Dynamic timing " + (enable ? "enabled" : "disabled") + " for intersection " + intersectionId + ", direction " + direction);
        } else {
            System.out.println("Signal timing not found for intersection " + intersectionId + ", direction " + direction);
        }
    }

...
import org.example._04_vendingmachine.domain.Recovery;
import org.example._04_vendingmachine.domain.RecoveryStatus;
...
public class RecoveryController {
    ...
    public void createRecoveryEntry(int machineId, int transactionId, VendingMachineState state){
        System.out.println("Controller: Creating recovery entry for machine " + machineId + ", transaction " + transactionId + ", state " + state.getStateName());

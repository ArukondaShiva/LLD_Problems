...
public class MessageDelivery {
    ...
    public MessageDelivery(String id,String messageId,String subscriberId,DeliveryChannel channel,DeliveryStatus status,long createdAt,Long acknowledgedAt){
        this.id = id;

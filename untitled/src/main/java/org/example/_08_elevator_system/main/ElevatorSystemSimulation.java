package org.example._08_elevator_system.main;

import org.example._08_elevator_system.controller.ElevatorController;
import org.example._08_elevator_system.controller.ElevatorPanelController;
import org.example._08_elevator_system.controller.FloorPanelController;
import org.example._08_elevator_system.domain.Building;
import org.example._08_elevator_system.domain.Elevator;
import org.example._08_elevator_system.domain.strategy.LoadBalancingStrategy;
...
public class ElevatorSystemSimulation {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            Building building = elevatorController.getBuildingService().createBuilding("Tech Tower",1,10,3);
            String buildingId = building.getId();
            System.out.println("Created building: " + building.getName() + " (Floors: " + building.getMinFloor() + "-" + building.getMaxFloor() + ")");
            ...
            System.out.println("Elevator IDs: " + elevator1.getId() + ", " + elevator2.getId() + ", " + elevator3.getId());



            // 3. Set strategies
            elevatorController.getDispatcherService().setElevatorSelectionStrategy(new LoadBalancingStrategy());
            ...
            floorPanelController.pressDownButton(2,buildingId);
